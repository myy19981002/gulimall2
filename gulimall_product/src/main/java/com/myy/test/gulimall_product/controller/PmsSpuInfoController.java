 ...
 */
@RestController
@RequestMapping("gulimall_product/pmsspuinfo")
public class PmsSpuInfoController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("gulimall_product:pmsspuinfo:list")
    ...
    //@RequiresPermissions("gulimall_product:pmsspuinfo:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("gulimall_product:pmsspuinfo:save")
    ...
    //@RequiresPermissions("gulimall_product:pmsspuinfo:update")
    ...
    //@RequiresPermissions("gulimall_product:pmsspuinfo:delete")
