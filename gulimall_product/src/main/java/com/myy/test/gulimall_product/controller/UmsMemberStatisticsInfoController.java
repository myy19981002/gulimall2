package com.myy.test.gulimall_product.controller;
...
import com.myy.test.gulimall_product.service.UmsMemberStatisticsInfoService;
import com.myy.common.utils.PageUtils;
import com.myy.common.utils.R;
 ...
 */
@RestController
@RequestMapping("gulimall_product/umsmemberstatisticsinfo")
public class UmsMemberStatisticsInfoController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("gulimall_product:umsmemberstatisticsinfo:list")
    ...
    //@RequiresPermissions("gulimall_product:umsmemberstatisticsinfo:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("gulimall_product:umsmemberstatisticsinfo:save")
    ...
    //@RequiresPermissions("gulimall_product:umsmemberstatisticsinfo:update")
    ...
    //@RequiresPermissions("gulimall_product:umsmemberstatisticsinfo:delete")
