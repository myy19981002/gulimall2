...
import com.myy.test.gulimall_product.entity.SmsSpuBoundsEntity;
import com.myy.test.gulimall_product.service.SmsSpuBoundsService;
 ...
 */
@RestController
@RequestMapping("gulimall_product/smsspubounds")
public class SmsSpuBoundsController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("gulimall_product:smsspubounds:list")
    ...
    //@RequiresPermissions("gulimall_product:smsspubounds:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("gulimall_product:smsspubounds:save")
    ...
    //@RequiresPermissions("gulimall_product:smsspubounds:update")
    ...
    //@RequiresPermissions("gulimall_product:smsspubounds:delete")
