...
import com.myy.test.gulimall_product.service.PmsSkuSaleAttrValueService;
 ...
 */
@RestController
@RequestMapping("gulimall_product/pmsskusaleattrvalue")
public class PmsSkuSaleAttrValueController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("gulimall_product:pmsskusaleattrvalue:list")
    ...
    //@RequiresPermissions("gulimall_product:pmsskusaleattrvalue:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("gulimall_product:pmsskusaleattrvalue:save")
    ...
    //@RequiresPermissions("gulimall_product:pmsskusaleattrvalue:update")
    ...
    //@RequiresPermissions("gulimall_product:pmsskusaleattrvalue:delete")
