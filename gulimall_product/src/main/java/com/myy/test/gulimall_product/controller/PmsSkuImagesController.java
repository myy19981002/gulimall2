...
import com.myy.test.gulimall_product.service.PmsSkuImagesService;
 ...
 */
@RestController
@RequestMapping("gulimall_product/pmsskuimages")
public class PmsSkuImagesController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("gulimall_product:pmsskuimages:list")
    ...
    //@RequiresPermissions("gulimall_product:pmsskuimages:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("gulimall_product:pmsskuimages:save")
    ...
    //@RequiresPermissions("gulimall_product:pmsskuimages:update")
    ...
    //@RequiresPermissions("gulimall_product:pmsskuimages:delete")
