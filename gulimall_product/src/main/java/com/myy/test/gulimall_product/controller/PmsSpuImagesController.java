 ...
 */
@RestController
@RequestMapping("gulimall_product/pmsspuimages")
public class PmsSpuImagesController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("gulimall_product:pmsspuimages:list")
    ...
    //@RequiresPermissions("gulimall_product:pmsspuimages:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("gulimall_product:pmsspuimages:save")
    ...
    //@RequiresPermissions("gulimall_product:pmsspuimages:update")
    ...
    //@RequiresPermissions("gulimall_product:pmsspuimages:delete")
