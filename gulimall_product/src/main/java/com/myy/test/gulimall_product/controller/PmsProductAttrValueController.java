 ...
 */
@RestController
@RequestMapping("gulimall_product/pmsproductattrvalue")
public class PmsProductAttrValueController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("gulimall_product:pmsproductattrvalue:list")
    ...
    //@RequiresPermissions("gulimall_product:pmsproductattrvalue:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("gulimall_product:pmsproductattrvalue:save")
    ...
    //@RequiresPermissions("gulimall_product:pmsproductattrvalue:update")
    ...
    //@RequiresPermissions("gulimall_product:pmsproductattrvalue:delete")
