 ...
 */
@RestController
@RequestMapping("gulimall_product/pmscategorybrandrelation")
public class PmsCategoryBrandRelationController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("gulimall_product:pmscategorybrandrelation:list")
    ...
    //@RequiresPermissions("gulimall_product:pmscategorybrandrelation:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("gulimall_product:pmscategorybrandrelation:save")
    ...
    //@RequiresPermissions("gulimall_product:pmscategorybrandrelation:update")
    ...
    //@RequiresPermissions("gulimall_product:pmscategorybrandrelation:delete")
