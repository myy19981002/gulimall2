 ...
 */
@RestController
@RequestMapping("gulimall_product/pmsspucomment")
public class PmsSpuCommentController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("gulimall_product:pmsspucomment:list")
    ...
    //@RequiresPermissions("gulimall_product:pmsspucomment:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("gulimall_product:pmsspucomment:save")
    ...
    //@RequiresPermissions("gulimall_product:pmsspucomment:update")
    ...
    //@RequiresPermissions("gulimall_product:pmsspucomment:delete")
