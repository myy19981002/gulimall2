 ...
 */
@RestController
@RequestMapping("gulimall_product/pmsattrattrgrouprelation")
public class PmsAttrAttrgroupRelationController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("gulimall_product:pmsattrattrgrouprelation:list")
    ...
    //@RequiresPermissions("gulimall_product:pmsattrattrgrouprelation:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("gulimall_product:pmsattrattrgrouprelation:save")
    ...
    //@RequiresPermissions("gulimall_product:pmsattrattrgrouprelation:update")
    ...
    //@RequiresPermissions("gulimall_product:pmsattrattrgrouprelation:delete")
