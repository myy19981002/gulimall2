...
import com.myy.test.gulimall_product.service.PmsCommentReplayService;
 ...
 */
@RestController
@RequestMapping("gulimall_product/pmscommentreplay")
public class PmsCommentReplayController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("gulimall_product:pmscommentreplay:list")
    ...
    //@RequiresPermissions("gulimall_product:pmscommentreplay:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("gulimall_product:pmscommentreplay:save")
    ...
    //@RequiresPermissions("gulimall_product:pmscommentreplay:update")
    ...
    //@RequiresPermissions("gulimall_product:pmscommentreplay:delete")
